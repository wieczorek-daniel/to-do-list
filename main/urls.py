...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name="main/password_reset.html", email_template_name='main/password_reset_email.html'), name="reset_password"),
